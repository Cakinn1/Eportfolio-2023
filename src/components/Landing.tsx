      ...
      >
        <div className="font-bold">
          <h1 className="leading-none animate__header  md:text-[120px]  text-[52px] text-left  ">
            Hey <br />{" "}
            <span className="text-[#888] r">I'm Anthony.</span>
          </h1>
          <p className="text-[52px] animate__title">Frontend Engineer</p>
          ...
          <div className="flex gap-x-4 mt-1 animate__links">
           ...
           <LandingLinks href="https://github.com/Cakinn1" icon={<FaGithub />} />
           <LandingLinks href="https://docs.google.com/document/d/1ad_ZrwaocB6kb4dDSArsiPPEKfK2qAZdrhXwz5fF-lQ/edit" icon={<FaFilePdf />} />
